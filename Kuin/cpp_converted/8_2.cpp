...
using k_cm=uint64_t(*)(type_(k_n));
static uint64_t k_y(type_(k_n) k_cp /*me*/);
using k_cr=uint32_t(*)(type_(k_n));
static double k_z(type_(k_n) k_cu /*me*/, double k_cv /*min*/, double k_cw /*max*/);
static void k_aa(type_(k_n) k_db /*me*/, uint32_t k_dc /*seed*/);
static uint32_t k_ab(type_(k_n) k_di /*me*/);
static void k_ac(k_n* k_dk);
static type_(k_n) k_ad(type_(k_n) k_dl);
static type_(Array_<uint8_t>) k_ae(type_(k_n) k_do);
static type_(k_n) k_af(type_(k_n) k_du, type_(Array_<uint8_t>) k_dv, int64_t* k_dw);
static type_(k_n) k_ag(type_(k_n) k_dz /*me2*/, uint32_t k_ea /*seed*/);
using k_eb=void(*)(type_(k_n), uint32_t);
template<typename T_>static T_ k_ai(T_ k_ec /*me_*/, type_(Array_<int64_t>) k_ed /*type*/, T_ k_ee /*n*/);
static int64_t k_aj();
static int64_t k_ak();
static int64_t k_an();
template<typename T_>static type_(Array_<char16_t>) k_bd(T_ k_em /*me_*/, type_(Array_<int64_t>) k_en /*type*/);
static void k_be(type_(Array_<char16_t>) k_eo /*str*/);
template<typename T_>static T_ k_cs(T_ k_ep /*me_*/, type_(Array_<int64_t>) k_eq /*type*/, T_ k_er /*n*/);
template<typename T_>static T_ k_ct(T_ k_es /*me_*/, type_(Array_<int64_t>) k_et /*type*/, int64_t k_eu /*n*/);
template<typename T_>static T_ k_dh(T_ k_ex /*me_*/, type_(Array_<int64_t>) k_ey /*type*/, int64_t k_ez /*n*/);
static type_(Array_<char16_t>) k_eg();
static int64_t k_ej(type_(Array_<char16_t>) k_fw /*me_*/, bool* k_fx /*success*/);
...
k_n::k_n(): k_o(), k_dd(), k_de(), k_df(), k_dg(){ Y = 8; }
k_n::~k_n(){
k_ac(this);
}
// k_main_
...
(k_am) = ((k_an)());
(k_ao) = ((k_an)());
(k_ap) = (newArrayBin_<char16_t>(9,"\x2D\x00\x31\x00\x20\x00\x2D\x00\x31\x00\x20\x00\x2D\x00\x31\x00\x0A\x00"));
for(k_at = (0LL), k_au = (k_am); k_at <= k_au; k_at += (1LL)){
for(k_ay = (0LL), k_az = ((k_am) - (k_at)); k_ay <= k_az; k_ay += (1LL)){
(k_ba) = (((k_am) - (k_at)) - (k_ay));
if(((((10000LL) * (k_at)) + ((5000LL) * (k_ay))) + ((1000LL) * (k_ba))) == (k_ao)){
(k_ap) = (((newArrayBin_<char16_t>(0,""))->Cat(k_bd<int64_t>((k_at), (nullptr))))->Cat(((newArrayBin_<char16_t>(1,"\x20\x00"))->Cat(k_bd<int64_t>((k_ay), (nullptr))))->Cat(((newArrayBin_<char16_t>(1,"\x20\x00"))->Cat(k_bd<int64_t>((k_ba), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00")))));
goto k_ar;
}
}
}
...
(k_ch) = (static_cast<uint64_t>(((k_cc) - (k_cb)) + (1LL)));
(k_ci) = ((0x0000000000000000ULL) - (((0x0000000000000000ULL) - (k_ch)) % (k_ch)));
(k_cj) = (0x0000000000000000ULL);
if((k_ci) == (0x0000000000000000ULL)){
(k_cj) = ((reinterpret_cast<k_cm>(classTable_[(k_ca)->Y + 9]))((k_ca)));
}
else{
do{
(k_cj) = ((reinterpret_cast<k_cm>(classTable_[(k_ca)->Y + 9]))((k_ca)));
...
return (static_cast<int64_t>((k_cj) % (k_ch))) + (k_cb);
}
// rndBit64
static uint64_t k_y(type_(k_n) k_cp /*me*/){
uint32_t k_cq; // t
(k_cq) = ((reinterpret_cast<k_cr>(classTable_[(k_cp)->Y + 12]))((k_cp)));
return k_cs<uint64_t>((k_ct<uint64_t>((static_cast<uint64_t>(k_cq)), (nullptr), (32LL))), (nullptr), (static_cast<uint64_t>((reinterpret_cast<k_cr>(classTable_[(k_cp)->Y + 12]))((k_cp)))));
}
// rndFloat
static double k_z(type_(k_n) k_cu /*me*/, double k_cv /*min*/, double k_cw /*max*/){
if((k_cv) >= (k_cw)){
...
return (((static_cast<double>((reinterpret_cast<k_cm>(classTable_[(k_cu)->Y + 9]))((k_cu)))) / (1.844674407370955e+19)) * ((k_cw) - (k_cv))) + (k_cv);
}
// setSeed
static void k_aa(type_(k_n) k_db /*me*/, uint32_t k_dc /*seed*/){
((k_db)->k_dd) = (0x075BCD15U);
((k_db)->k_de) = (0x159A55E5U);
((k_db)->k_df) = ((0x1F123BB5U) * (k_dc));
((k_db)->k_dg) = ((0x05491333U) * (k_dh<uint32_t>(((k_db)->k_df), (nullptr), (1LL))));
}
// xs128
static uint32_t k_ab(type_(k_n) k_di /*me*/){
uint32_t k_dj; // t
(k_dj) = (k_ai<uint32_t>(((k_di)->k_dd), (nullptr), (k_ct<uint32_t>(((k_di)->k_dd), (nullptr), (11LL)))));
((k_di)->k_dd) = ((k_di)->k_de);
((k_di)->k_de) = ((k_di)->k_df);
((k_di)->k_df) = ((k_di)->k_dg);
((k_di)->k_dg) = (k_ai<uint32_t>((k_ai<uint32_t>(((k_di)->k_dg), (nullptr), (k_dh<uint32_t>(((k_di)->k_dg), (nullptr), (19LL))))), (nullptr), (k_ai<uint32_t>((k_dj), (nullptr), (k_dh<uint32_t>((k_dj), (nullptr), (8LL)))))));
return (k_di)->k_dg;
}
// _dtor
static void k_ac(k_n* k_dk){
...
((k_dm)->k_df) = ((k_dl)->k_df);
((k_dm)->k_dg) = ((k_dl)->k_dg);
return as_<k_n>(classTable_, (k_dm), 8);
}
// _toBin
static type_(Array_<uint8_t>) k_ae(type_(k_n) k_do){
type_(Array_<uint8_t>) k_dp;
(k_dp) = (newArrays_<type_(Array_<uint8_t>)>((0LL)));
(k_dp) = ((k_dp)->Cat(toBin_<uint32_t>()(((k_do)->k_dd))));
(k_dp) = ((k_dp)->Cat(toBin_<uint32_t>()(((k_do)->k_de))));
(k_dp) = ((k_dp)->Cat(toBin_<uint32_t>()(((k_do)->k_df))));
(k_dp) = ((k_dp)->Cat(toBin_<uint32_t>()(((k_do)->k_dg))));
return k_dp;
}
// _fromBin
static type_(k_n) k_af(type_(k_n) k_du, type_(Array_<uint8_t>) k_dv, int64_t* k_dw){
...
((k_dx)->k_dd) = (fromBin_<uint32_t>()((k_dv), (*k_dw)));
((k_dx)->k_de) = (fromBin_<uint32_t>()((k_dv), (*k_dw)));
((k_dx)->k_df) = (fromBin_<uint32_t>()((k_dv), (*k_dw)));
((k_dx)->k_dg) = (fromBin_<uint32_t>()((k_dv), (*k_dw)));
return k_dx;
}
// makeRnd
static type_(k_n) k_ag(type_(k_n) k_dz /*me2*/, uint32_t k_ea /*seed*/){
(reinterpret_cast<k_eb>(classTable_[(k_dz)->Y + 11]))((k_dz), (k_ea));
return k_dz;
}
// _xor
template<typename T_>static T_ k_ai(T_ k_ec /*me_*/, type_(Array_<int64_t>) k_ed /*type*/, T_ k_ee /*n*/){
