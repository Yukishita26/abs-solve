...
static int64_t k_ak();
static int64_t k_an();
static int64_t k_ax(int64_t k_ek /*n*/);
static void k_bb(type_(Array_<char16_t>) k_ep /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_bc(T_ k_eq /*me_*/, type_(Array_<int64_t>) k_er /*type*/);
template<typename T_>static T_ k_cq(T_ k_es /*me_*/, type_(Array_<int64_t>) k_et /*type*/, T_ k_eu /*n*/);
template<typename T_>static T_ k_cr(T_ k_ev /*me_*/, type_(Array_<int64_t>) k_ew /*type*/, int64_t k_ex /*n*/);
template<typename T_>static T_ k_df(T_ k_fa /*me_*/, type_(Array_<int64_t>) k_fb /*type*/, int64_t k_fc /*n*/);
static type_(Array_<char16_t>) k_ee();
static int64_t k_eh(type_(Array_<char16_t>) k_fz /*me_*/, bool* k_ga /*success*/);
static char16_t k_fl();
template<typename T_>static T_ k_fy(T_ k_gp /*me_*/, type_(Array_<int64_t>) k_gq /*type*/, int64_t k_gr /*start*/, int64_t k_gs /*len*/);
...
k_n::k_n(): k_o(), k_db(), k_dc(), k_dd(), k_de(){ Y = 8; }
k_n::~k_n(){
k_ac(this);
}
// k_main_
...
(k_ap) = ((k_an)());
(k_aq) = (0LL);
for(k_au = (0LL), k_av = (k_am); k_au <= k_av; k_au += (1LL)){
(k_aw) = ((k_ax)((k_au)));
if(((k_ao) <= (k_aw)) && ((k_aw) <= (k_ap))){
(k_aq) = ((k_aq) + (k_au));
}
}
(k_bb)((((newArrayBin_<char16_t>(0,""))->Cat(k_bc<int64_t>((k_aq), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
...
(k_bo) = (newArrays_<type_(Array_<uint8_t>)>((0LL)));
return k_bo;
}
// _fromBin
static type_(k_o) k_u(type_(k_o) k_bp /*me*/, type_(Array_<uint8_t>) k_bq /*bin*/, int64_t* k_br /*idx*/){
...
(k_cf) = (static_cast<uint64_t>(((k_ca) - (k_bz)) + (1LL)));
...
// setSeed
static void k_aa(type_(k_n) k_cz /*me*/, uint32_t k_da /*seed*/){
((k_cz)->k_db) = (0x075BCD15U);
((k_cz)->k_dc) = (0x159A55E5U);
((k_cz)->k_dd) = ((0x1F123BB5U) * (k_da));
((k_cz)->k_de) = ((0x05491333U) * (k_df<uint32_t>(((k_cz)->k_dd), (nullptr), (1LL))));
}
// xs128
static uint32_t k_ab(type_(k_n) k_dg /*me*/){
uint32_t k_dh; // t
(k_dh) = (k_ai<uint32_t>(((k_dg)->k_db), (nullptr), (k_cr<uint32_t>(((k_dg)->k_db), (nullptr), (11LL)))));
((k_dg)->k_db) = ((k_dg)->k_dc);
((k_dg)->k_dc) = ((k_dg)->k_dd);
((k_dg)->k_dd) = ((k_dg)->k_de);
((k_dg)->k_de) = (k_ai<uint32_t>((k_ai<uint32_t>(((k_dg)->k_de), (nullptr), (k_df<uint32_t>(((k_dg)->k_de), (nullptr), (19LL))))), (nullptr), (k_ai<uint32_t>((k_dh), (nullptr), (k_df<uint32_t>((k_dh), (nullptr), (8LL)))))));
return (k_dg)->k_de;
}
// _dtor
static void k_ac(k_n* k_di){
...
(k_dn) = (newArrays_<type_(Array_<uint8_t>)>((0LL)));
...
// _shl
template<typename T_>static T_ k_cr(T_ k_ev /*me_*/, type_(Array_<int64_t>) k_ew /*type*/, int64_t k_ex /*n*/){
if(k_ex<0||k_ex>=sizeof(k_ev)*8)throw 0xe9170006;
return k_ev<<k_ex;
}
// _shr
template<typename T_>static T_ k_df(T_ k_fa /*me_*/, type_(Array_<int64_t>) k_fb /*type*/, int64_t k_fc /*n*/){
...
// inputStr
static type_(Array_<char16_t>) k_ee(){
type_(Array_<char16_t>) k_ff; // buf
int64_t k_fg; // ptr
char16_t k_fk; // c
(k_ff) = (newArrays_<type_(Array_<char16_t>)>((1024LL)));
(k_fg) = (0LL);
while(true){
(k_fk) = ((k_fl)());
if((k_fk) == (u'\uFFFF')){
...
if((k_fg) == ((k_ff)->Len())){
(k_ff) = ((k_ff)->Cat(newArrays_<type_(Array_<char16_t>)>((1024LL))));
}
((k_ff)->At(k_fg)) = (k_fk);
(k_fg) = ((k_fg) + (1LL));
}
return k_fy<type_(Array_<char16_t>)>((k_ff), (nullptr), (0LL), (k_fg));
}
// _toInt
static int64_t k_eh(type_(Array_<char16_t>) k_fz /*me_*/, bool* k_ga /*success*/){
std::u16string u_=k_fz->B;
...
while(true){
(k_ge) = ((k_gf)());
for(k_gj = (0LL), k_gk = (((k_al)->Len()) - (1LL)); k_gj <= k_gk; k_gj += (1LL)){
if(((k_ge) == ((k_al)->At(k_gj))) || (((k_ge) == (u'\u000D')) && (((k_al)->At(k_gj)) == (u'\u000A')))){
return u'\u0000';
}
}
if((k_ge) == (u'\u000D')){
