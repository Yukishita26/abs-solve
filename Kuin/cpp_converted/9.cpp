...
using k_by=uint64_t(*)(type_(k_n));
static uint64_t k_y(type_(k_n) k_cb /*me*/);
using k_cd=uint32_t(*)(type_(k_n));
static double k_z(type_(k_n) k_cg /*me*/, double k_ch /*min*/, double k_ci /*max*/);
static void k_aa(type_(k_n) k_cn /*me*/, uint32_t k_co /*seed*/);
static uint32_t k_ab(type_(k_n) k_cu /*me*/);
static void k_ac(k_n* k_cw);
static type_(k_n) k_ad(type_(k_n) k_cx);
static type_(Array_<uint8_t>) k_ae(type_(k_n) k_da);
static type_(k_n) k_af(type_(k_n) k_dg, type_(Array_<uint8_t>) k_dh, int64_t* k_di);
static type_(k_n) k_ag(type_(k_n) k_dl /*me2*/, uint32_t k_dm /*seed*/);
using k_dn=void(*)(type_(k_n), uint32_t);
template<typename T_>static T_ k_ai(T_ k_do /*me_*/, type_(Array_<int64_t>) k_dp /*type*/, T_ k_dq /*n*/);
static int64_t k_aj();
static int64_t k_ak();
static type_(Array_<char16_t>) k_an();
static type_(Array_<char16_t>) k_ao(type_(Array_<char16_t>) k_el /*me_*/, type_(Array_<char16_t>) k_em /*old*/, type_(Array_<char16_t>) k_en /*new*/);
static void k_ap(type_(Array_<char16_t>) k_fb /*str*/);
template<typename T_>static T_ k_ce(T_ k_fc /*me_*/, type_(Array_<int64_t>) k_fd /*type*/, T_ k_fe /*n*/);
template<typename T_>static T_ k_cf(T_ k_ff /*me_*/, type_(Array_<int64_t>) k_fg /*type*/, int64_t k_fh /*n*/);
template<typename T_>static T_ k_ct(T_ k_fk /*me_*/, type_(Array_<int64_t>) k_fl /*type*/, int64_t k_fm /*n*/);
static char16_t k_dx();
template<typename T_>static T_ k_ek(T_ k_gd /*me_*/, type_(Array_<int64_t>) k_ge /*type*/, int64_t k_gf /*start*/, int64_t k_gg /*len*/);
static int64_t k_ew(type_(Array_<char16_t>) k_gh /*me_*/, type_(Array_<char16_t>) k_gi /*pattern*/, int64_t k_gj /*start*/);
static char16_t k_ft();
...
k_n::k_n(): k_o(), k_cp(), k_cq(), k_cr(), k_cs(){ Y = 8; }
k_n::~k_n(){
k_ac(this);
}
// k_main_
...
type_(Array_<char16_t>) k_aq;
(k_am) = ((k_an)());
(k_am) = ((k_ao)((k_am), (newArrayBin_<char16_t>(6,"\x65\x00\x72\x00\x61\x00\x73\x00\x65\x00\x72\x00")), (newArrayBin_<char16_t>(1,"\x21\x00"))));
(k_am) = ((k_ao)((k_am), (newArrayBin_<char16_t>(5,"\x65\x00\x72\x00\x61\x00\x73\x00\x65\x00")), (newArrayBin_<char16_t>(1,"\x21\x00"))));
(k_am) = ((k_ao)((k_am), (newArrayBin_<char16_t>(7,"\x64\x00\x72\x00\x65\x00\x61\x00\x6D\x00\x65\x00\x72\x00")), (newArrayBin_<char16_t>(1,"\x21\x00"))));
(k_am) = ((k_ao)((k_am), (newArrayBin_<char16_t>(5,"\x64\x00\x72\x00\x65\x00\x61\x00\x6D\x00")), (newArrayBin_<char16_t>(1,"\x21\x00"))));
(k_am) = ((k_ao)((k_am), (newArrayBin_<char16_t>(1,"\x21\x00")), (newArrayBin_<char16_t>(0,""))));
(k_ap)((((k_aq=(k_am),k_aq->L==0) ? (newArrayBin_<char16_t>(3,"\x59\x00\x45\x00\x53\x00")) : (newArrayBin_<char16_t>(2,"\x4E\x00\x4F\x00")))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
...
(k_bt) = (static_cast<uint64_t>(((k_bo) - (k_bn)) + (1LL)));
(k_bu) = ((0x0000000000000000ULL) - (((0x0000000000000000ULL) - (k_bt)) % (k_bt)));
(k_bv) = (0x0000000000000000ULL);
if((k_bu) == (0x0000000000000000ULL)){
(k_bv) = ((reinterpret_cast<k_by>(classTable_[(k_bm)->Y + 9]))((k_bm)));
}
else{
do{
(k_bv) = ((reinterpret_cast<k_by>(classTable_[(k_bm)->Y + 9]))((k_bm)));
...
return (static_cast<int64_t>((k_bv) % (k_bt))) + (k_bn);
}
// rndBit64
static uint64_t k_y(type_(k_n) k_cb /*me*/){
uint32_t k_cc; // t
(k_cc) = ((reinterpret_cast<k_cd>(classTable_[(k_cb)->Y + 12]))((k_cb)));
return k_ce<uint64_t>((k_cf<uint64_t>((static_cast<uint64_t>(k_cc)), (nullptr), (32LL))), (nullptr), (static_cast<uint64_t>((reinterpret_cast<k_cd>(classTable_[(k_cb)->Y + 12]))((k_cb)))));
}
// rndFloat
static double k_z(type_(k_n) k_cg /*me*/, double k_ch /*min*/, double k_ci /*max*/){
if((k_ch) >= (k_ci)){
...
return (((static_cast<double>((reinterpret_cast<k_by>(classTable_[(k_cg)->Y + 9]))((k_cg)))) / (1.844674407370955e+19)) * ((k_ci) - (k_ch))) + (k_ch);
}
// setSeed
static void k_aa(type_(k_n) k_cn /*me*/, uint32_t k_co /*seed*/){
((k_cn)->k_cp) = (0x075BCD15U);
((k_cn)->k_cq) = (0x159A55E5U);
((k_cn)->k_cr) = ((0x1F123BB5U) * (k_co));
((k_cn)->k_cs) = ((0x05491333U) * (k_ct<uint32_t>(((k_cn)->k_cr), (nullptr), (1LL))));
}
// xs128
static uint32_t k_ab(type_(k_n) k_cu /*me*/){
uint32_t k_cv; // t
(k_cv) = (k_ai<uint32_t>(((k_cu)->k_cp), (nullptr), (k_cf<uint32_t>(((k_cu)->k_cp), (nullptr), (11LL)))));
((k_cu)->k_cp) = ((k_cu)->k_cq);
((k_cu)->k_cq) = ((k_cu)->k_cr);
((k_cu)->k_cr) = ((k_cu)->k_cs);
((k_cu)->k_cs) = (k_ai<uint32_t>((k_ai<uint32_t>(((k_cu)->k_cs), (nullptr), (k_ct<uint32_t>(((k_cu)->k_cs), (nullptr), (19LL))))), (nullptr), (k_ai<uint32_t>((k_cv), (nullptr), (k_ct<uint32_t>((k_cv), (nullptr), (8LL)))))));
return (k_cu)->k_cs;
}
// _dtor
static void k_ac(k_n* k_cw){
...
type_(k_n) k_cy;
type_(k_n) k_cz;
(k_cy) = (k_cz = new_(k_n)(), k_w(k_cz), k_cz);
((k_cy)->k_cp) = ((k_cx)->k_cp);
((k_cy)->k_cq) = ((k_cx)->k_cq);
((k_cy)->k_cr) = ((k_cx)->k_cr);
((k_cy)->k_cs) = ((k_cx)->k_cs);
return as_<k_n>(classTable_, (k_cy), 8);
}
// _toBin
static type_(Array_<uint8_t>) k_ae(type_(k_n) k_da){
type_(Array_<uint8_t>) k_db;
(k_db) = (newArrays_<type_(Array_<uint8_t>)>((0LL)));
(k_db) = ((k_db)->Cat(toBin_<uint32_t>()(((k_da)->k_cp))));
(k_db) = ((k_db)->Cat(toBin_<uint32_t>()(((k_da)->k_cq))));
(k_db) = ((k_db)->Cat(toBin_<uint32_t>()(((k_da)->k_cr))));
(k_db) = ((k_db)->Cat(toBin_<uint32_t>()(((k_da)->k_cs))));
return k_db;
}
// _fromBin
static type_(k_n) k_af(type_(k_n) k_dg, type_(Array_<uint8_t>) k_dh, int64_t* k_di){
type_(k_n) k_dj;
type_(k_n) k_dk;
(k_dj) = (k_dk = new_(k_n)(), k_w(k_dk), k_dk);
((k_dj)->k_cp) = (fromBin_<uint32_t>()((k_dh), (*k_di)));
((k_dj)->k_cq) = (fromBin_<uint32_t>()((k_dh), (*k_di)));
((k_dj)->k_cr) = (fromBin_<uint32_t>()((k_dh), (*k_di)));
((k_dj)->k_cs) = (fromBin_<uint32_t>()((k_dh), (*k_di)));
return k_dj;
}
// makeRnd
static type_(k_n) k_ag(type_(k_n) k_dl /*me2*/, uint32_t k_dm /*seed*/){
(reinterpret_cast<k_dn>(classTable_[(k_dl)->Y + 11]))((k_dl), (k_dm));
return k_dl;
}
// _xor
template<typename T_>static T_ k_ai(T_ k_do /*me_*/, type_(Array_<int64_t>) k_dp /*type*/, T_ k_dq /*n*/){
...
// inputStr
static type_(Array_<char16_t>) k_an(){
type_(Array_<char16_t>) k_dr; // buf
int64_t k_ds; // ptr
char16_t k_dw; // c
(k_dr) = (newArrays_<type_(Array_<char16_t>)>((1024LL)));
(k_ds) = (0LL);
while(true){
(k_dw) = ((k_dx)());
if((k_dw) == (u'\uFFFF')){
...
if((k_ds) == ((k_dr)->Len())){
(k_dr) = ((k_dr)->Cat(newArrays_<type_(Array_<char16_t>)>((1024LL))));
}
((k_dr)->At(k_ds)) = (k_dw);
(k_ds) = ((k_ds) + (1LL));
}
return k_ek<type_(Array_<char16_t>)>((k_dr), (nullptr), (0LL), (k_ds));
}
// _replace
static type_(Array_<char16_t>) k_ao(type_(Array_<char16_t>) k_el /*me_*/, type_(Array_<char16_t>) k_em /*old*/, type_(Array_<char16_t>) k_en /*new*/){
type_(Array_<char16_t>) k_eq; // r
int64_t k_er; // p
int64_t k_ev; // p2
if(((k_em)->Len()) == (0LL)){
return k_el;
}
(k_eq) = (newArrayBin_<char16_t>(0,""));
(k_er) = (0LL);
while((k_er) < ((k_el)->Len())){
(k_ev) = ((k_ew)((k_el), (k_em), (k_er)));
if((k_ev) == (-1LL)){
(k_eq) = ((k_eq)->Cat(k_ek<type_(Array_<char16_t>)>((k_el), (nullptr), (k_er), (-1LL))));
break;
}
(k_eq) = ((k_eq)->Cat((k_ek<type_(Array_<char16_t>)>((k_el), (nullptr), (k_er), ((k_ev) - (k_er))))->Cat(k_en)));
(k_er) = ((k_ev) + ((k_em)->Len()));
}
return k_eq;
}
...
#if defined(_WIN32)
fputws(reinterpret_cast<const wchar_t*>(k_fb->B),stdout);
#else
std::u16string s_=k_fb->B;
...
// _shl
template<typename T_>static T_ k_cf(T_ k_ff /*me_*/, type_(Array_<int64_t>) k_fg /*type*/, int64_t k_fh /*n*/){
if(k_fh<0||k_fh>=sizeof(k_ff)*8)throw 0xe9170006;
return k_ff<<k_fh;
}
// _shr
template<typename T_>static T_ k_ct(T_ k_fk /*me_*/, type_(Array_<int64_t>) k_fl /*type*/, int64_t k_fm /*n*/){
if(k_fm<0||k_fm>=sizeof(k_fk)*8)throw 0xe9170006;
return k_fk>>k_fm;
}
...
while(true){
(k_fs) = ((k_ft)());
for(k_fx = (0LL), k_fy = (((k_al)->Len()) - (1LL)); k_fx <= k_fy; k_fx += (1LL)){
if(((k_fs) == ((k_al)->At(k_fx))) || (((k_fs) == (u'\u000D')) && (((k_al)->At(k_fx)) == (u'\u000A')))){
return u'\u0000';
}
}
if((k_fs) == (u'\u000D')){
...
for(k_gr = (k_gj), k_gs = (((k_gh)->Len()) - ((k_gi)->Len())); k_gr <= k_gs; k_gr += (1LL)){
for(k_gw = (0LL), k_gx = (((k_gi)->Len()) - (1LL)); k_gw <= k_gx; k_gw += (1LL)){
if(((k_gh)->At((k_gr) + (k_gw))) != ((k_gi)->At(k_gw))){
goto k_gq;
}
}
return k_gr;
