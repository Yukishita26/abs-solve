...
static int64_t k_ak();
static int64_t k_an();
static void k_bi(type_(Array_<char16_t>) k_er /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_bj(T_ k_es /*me_*/, type_(Array_<int64_t>) k_et /*type*/);
template<typename T_>static T_ k_cx(T_ k_eu /*me_*/, type_(Array_<int64_t>) k_ev /*type*/, T_ k_ew /*n*/);
template<typename T_>static T_ k_cy(T_ k_ex /*me_*/, type_(Array_<int64_t>) k_ey /*type*/, int64_t k_ez /*n*/);
template<typename T_>static T_ k_dm(T_ k_fc /*me_*/, type_(Array_<int64_t>) k_fd /*type*/, int64_t k_fe /*n*/);
static type_(Array_<char16_t>) k_el();
static int64_t k_eo(type_(Array_<char16_t>) k_gb /*me_*/, bool* k_gc /*success*/);
static char16_t k_fn();
template<typename T_>static T_ k_ga(T_ k_gr /*me_*/, type_(Array_<int64_t>) k_gs /*type*/, int64_t k_gt /*start*/, int64_t k_gu /*len*/);
static char16_t k_gh();
...
if((((k_ao)->At(k_bb)) % (2LL)) == (0LL)){
((k_ao)->At(k_bb)) = (((k_ao)->At(k_bb)) / (2LL));
}
else{
goto k_aw;
}
...
k_aw:;
(k_bi)((k_bj<int64_t>((k_au), (nullptr))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
...
#if defined(_WIN32)
fputws(reinterpret_cast<const wchar_t*>(k_er->B),stdout);
#else
std::u16string s_=k_er->B;
...
// _shr
template<typename T_>static T_ k_dm(T_ k_fc /*me_*/, type_(Array_<int64_t>) k_fd /*type*/, int64_t k_fe /*n*/){
if(k_fe<0||k_fe>=sizeof(k_fc)*8)throw 0xe9170006;
return k_fc>>k_fe;
}
// inputStr
static type_(Array_<char16_t>) k_el(){
type_(Array_<char16_t>) k_fh; // buf
int64_t k_fi; // ptr
char16_t k_fm; // c
(k_fh) = (newArrays_<type_(Array_<char16_t>)>((1024LL)));
(k_fi) = (0LL);
while(true){
(k_fm) = ((k_fn)());
if((k_fm) == (u'\uFFFF')){
...
if((k_fi) == ((k_fh)->Len())){
(k_fh) = ((k_fh)->Cat(newArrays_<type_(Array_<char16_t>)>((1024LL))));
}
((k_fh)->At(k_fi)) = (k_fm);
(k_fi) = ((k_fi) + (1LL));
}
return k_ga<type_(Array_<char16_t>)>((k_fh), (nullptr), (0LL), (k_fi));
}
// _toInt
static int64_t k_eo(type_(Array_<char16_t>) k_gb /*me_*/, bool* k_gc /*success*/){
std::u16string u_=k_gb->B;
...
while(true){
(k_gg) = ((k_gh)());
for(k_gl = (0LL), k_gm = (((k_al)->Len()) - (1LL)); k_gl <= k_gm; k_gl += (1LL)){
if(((k_gg) == ((k_al)->At(k_gl))) || (((k_gg) == (u'\u000D')) && (((k_al)->At(k_gl)) == (u'\u000A')))){
return u'\u0000';
}
}
if((k_gg) == (u'\u000D')){
